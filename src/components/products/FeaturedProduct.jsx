          ...
          <div className='flex flex-col justify-center items-center bg-zinc-200 pb-3' style={{width: (itemWidth)}}>
            <div className='flex flex-col justify-center items-center bg-white' style={{width: (itemWidth)}}>
              <div className='flex flex-col xxs:flex-row justify-between items-start'>
                <div className='flex justify-center items-center relative w-full xxs:w-fit mt-2 xxs:mt-0 mb-1 xxs:mb-0'>
                  <div className='flex justify-center items-center relative' style={{width: itemWidth<200?itemWidth:(150), maxWidth: 200, height: itemWidth<200?itemWidth:(150)}}>
                    {val.image_url==="none"?<CameraAlt sx={{width: 80, height: 80, color: '#cbd5e1'}}/>:
                    <Image src={val.image_url} alt="product image" fill sizes={'(max-width: 200px) '+itemWidth+'px, 150px'} priority={true} style={{objectFit: 'cover'}}/>}
                  </div>
                </div>
                <div className="flex flex-col justify-start items-start" style={{width: itemWidth>340?(itemWidth-150):itemWidth}}>
                  ...
                  <div className='flex flex-row overflow-hidden px-2 gap-1 flex-wrap h-fit xxs:h-[75px] xs:h-[65px] mb-2 xxs:mb-0'>
