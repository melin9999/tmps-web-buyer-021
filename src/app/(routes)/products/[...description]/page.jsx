...
import { ArrowBack, CameraAlt, ControlPoint, HdrPlus, RemoveCircleOutline, ShoppingCart } from '@mui/icons-material';
...
const Products = ({params}) => {
  ...
  useEffect(() => {
    if(params.description[0] && parseInt(params.description[0])){
      loadItem(parseInt(params.description[0]));
    }
  }, []);
                      ...
                      {selectedImage ? 
                        <ReactImageMagnify {...{
                            smallImage: {
                                ...
                                sizes: '(max-width: 440px) 300px, (max-width: 640px) 400px, (max-width: 768px) 250px, (max-width: 1024px) 300px, 400px'
                            },
                            largeImage: {
                                src: selectedImage.imageUrl,
                                width: 1200,
                            ...
                            enlargedImagePosition: smallScreen?'over':'beside',
                        }} />:
