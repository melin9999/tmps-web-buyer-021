      ...
      <div className='form_container_medium'>
          ...
          <div className='form_fields_container'>
            ...
            <div className='form_row_double_fixed'>
              ...
              <Button 
                ...
                endIcon={isSaving||isLoading?<CircularProgress size={18} style={{'color': '#9ca3af'}}/>:<ArrowForward />}
                onClick={()=>checkUser()}
              >
          ...
          <div className='form_fields_container'>
            ...
            <div className='form_row_double_fixed'>
              ...
              <Button 
                ...
                disabled={isSaving||isLoading} 
                style={{textTransform: 'none'}} 
                endIcon={isSaving||isLoading?<CircularProgress size={18} style={{'color': '#9ca3af'}}/>:<Save />}
                onClick={()=>saveClicked()}
              >Save</Button>
            </div>
          </div>
        ...
        <div className='form_row_single mt-3'>
          <Button 
            ...
            disabled={isSaving||isLoading} 
            style={{textTransform: 'none'}} 
            startIcon={isSaving||isLoading?<CircularProgress size={18} style={{'color': '#9ca3af'}}/>:<Login />}
            onClick={()=>{
              if(session && session.user){
                signOut();
                router.push('/signin');
